        ...
        {!loading && !error && products.length > 0 && (
          <>
            <div className="mb-8 bg-white p-4 rounded-lg shadow-sm inline-block border border-gray-100">
              ...
              <select 
                id="category-filter" 
                className="block w-full min-w-[200px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-white"
